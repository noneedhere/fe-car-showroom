...
const Shop = () => (
    <div className="px-50 py-10 min-w-full mx-auto bg-slate-100">
        ...
        <div className="grid grid-cols-2 gap-6 p-10">
            ...
            {/* CARD 1 */}
            <div className="group bg-slate-50 text-[#181818] rounded-xl overflow-hidden shadow-sm relative w-auto p-10">
                ...
                <div className='py-3 font-medium'>
                    <Link href="/sales/shop/transaction/model1" passHref>
                        <button
            ...
            <div className="group bg-slate-50 text-[#181818] rounded-xl overflow-hidden shadow-sm relative w-auto p-10">
                ...
                <div className='py-3 font-medium'>
                    <Link href="/sales/shop/transaction/model3" passHref>
                        <button
                            className="w-full bg-cyan-400 text-white text-sm px-8 py-3 rounded border transition-all duration-300 transform hover:scale-105">
                            Get Your Porsche
                        </button>
            ...
            <div className="group bg-slate-50 text-[#181818] rounded-xl overflow-hidden shadow-sm relative w-auto p-10">
                ...
                <div className='py-3 font-medium'>
                    <Link href="/sales/shop/transaction/model4" passHref>
                        <button
                            className="w-full bg-cyan-400 text-white text-sm px-8 py-3 rounded border transition-all duration-300 transform hover:scale-105">
                            Get Your Porsche
                        </button>
